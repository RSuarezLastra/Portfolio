...
const Intro = () => {
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-0 md:gap-10 min-h-screen p-4 md:p-10 lg:p-16 w-10/12 mx-auto">
            <div className="flex flex-col justify-center">
                <h1 className="text-center sm:text-left text-3xl sm:text-5xl font-semibold mb-1 lg:mb-4 dark:text-slate-100">
                    Hi, I'm <span className='text-seance-700'>Raul</span> Suarez Fullstack developer</h1>
